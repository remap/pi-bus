...
class Dactyl:
    ...
    def __init__(self, config):
        ...
        self.kinetsender = [None, None, None]
        
        numStrands = 1 
        for n in range (len(IPS)):  
            self.kinetsender[n] = KinetSender("192.168.1.2", IPS[n], numStrands, self.STRAND_SIZE*self.COLORS_PER_LIGHT)
    ...
    def _sendLightCommand(self, lightNum, colorArray):
        self.kinetsender[lightNum].setPayload(1, colorArray)
